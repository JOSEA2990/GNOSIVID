...
const SERIES = [
    {
        ...
        episodes: [
            {id:'p6-e1', title:'Introducción a Primavera P6', duration:'2:00', src:"https://pruebavideosjose.s3.eu-north-1.amazonaws.com/Primavera+-+Video+Clase1.mp4", desc:'Qué es Primavera P6, EPS, WBS y la interfaz.'},
    ...
    { id:'Tratamiento', title:'Sistema de pre-Tratamiento', category:'energia', description:'Control de versiones con GIT', episodes:   
        [
        {id:'MSP-e1', title:'Sistema de Pre-Tratamiento de Agua', duration:'0:55', src:"https://pruebavideosjose.s3.eu-north-1.amazonaws.com/Tratamiento.mp4", desc:'Descripción del Sistema en practica.'}
        ] 
    },
